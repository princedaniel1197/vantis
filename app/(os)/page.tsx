...
const PRODUCTS = [
  ...
  },
  {
    ...
    tag: 'For Developers',
    name: 'Vantis Build',
    desc: 'The operating system for real estate developers. Sales, finance, land intelligence, and feasibility — unified in one platform.',
    href: '/command',
    icon: LayoutGrid,
    features: ['Command Centre', 'Sales Pipeline', 'Land Intelligence', 'Feasibility Engine'],
    accent: '#B8C8D8',
  ...
  },
  {
    ...
    tag: 'For Brokers',
    name: 'Vantis Connect',
    desc: "The broker's brain — AI buyer-property matching, WhatsApp-native pipeline, and Kaveri market truth. Built for Karnataka's 50,000+ brokers.",
    href: '/connect',
    icon: Brain,
