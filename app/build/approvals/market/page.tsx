...
export default function MarketPage() {
  ...
  return (
    <div className="min-h-screen bg-background max-w-[1100px] mx-auto">
      {/* Page header */}
      <div className="px-6 sm:px-8 py-5 border-b border-border shrink-0">
        <div className="text-[9px] font-mono uppercase tracking-[0.28em] text-gray mb-2">
          Vantis Build · Developer Intelligence · Divya Villas · Mysuru
        </div>
        <h1 className="font-syne text-2xl sm:text-3xl font-bold text-off-white leading-none">
          Competitive Supply Intelligence
        </h1>
      </div>
      ...
      <div className="px-6 sm:px-8 py-6">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-[10px] font-mono text-gray uppercase tracking-[0.12em]">Competitive Supply</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          >
            <span className="font-mono text-[9px] uppercase tracking-[0.22em] text-gray">2.5 km Radius Map · Mysuru</span>
            <svg viewBox="0 0 600 500" className="w-full mt-3">
              <defs>
          ...
          <div className="flex flex-col gap-4">
            ...
            <motion.div
              ...
              className="bg-surface border border-border rounded-sm p-4 sm:p-5 hover:border-gold/30 transition-all"
            >
              <span className="font-mono text-[9px] uppercase tracking-[0.22em] text-gold">{selected.name}</span>
              <div className="grid grid-cols-2 gap-3 text-xs mt-4">
                {[
                  ...
                  <div key={f.label}>
                    ...
                    <div className="text-off-white font-mono mt-1">{f.value}</div>
                  </div>
                ))}
              </div>
            ...
            <motion.div
              ...
              className="bg-gold/[0.08] border border-gold/25 rounded-sm p-4 hover:border-gold/40 transition-all"
            >
              <div className="flex items-center gap-1.5 mb-2">
                <div className="w-1.5 h-1.5 rounded-full bg-gold" />
                <span className="font-mono text-[9px] uppercase tracking-[0.22em] text-gold">Market Intelligence</span>
              </div>
            ...
            >
              <div className="px-4 py-3 border-b border-border">
                <span className="font-mono text-[9px] uppercase tracking-[0.22em] text-gray">All Projects in Radius</span>
              </div>
