            ...
            <div key={c.id} className="bg-surface border border-border rounded-sm overflow-hidden">
              <div className="p-4 cursor-pointer" onClick={() => toggleExpand(c.id)}>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div>
                    <div className="text-[10px] text-gray uppercase tracking-wide mb-0.5">Nature</div>
                  ...
                  <div>
                    <div className="text-[10px] text-gray uppercase tracking-wide mb-0.5">Next Hearing</div>
      ...
      {scheduleModal && (
        ...
        >
          ...
          >
            ...
            <div className="mb-6">
              <label className="text-[10px] uppercase tracking-widest text-gray block mb-2">
                Hearing Date
              </label>
              <input
                type="date"
