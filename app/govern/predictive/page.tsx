    ...
    <div className="flex flex-col min-h-full text-off-white">
      ...
      <div className="px-6 sm:px-8 py-5 border-b border-border shrink-0">
        <div className="text-[9px] font-mono uppercase tracking-[0.28em] text-gray mb-2">
          K-RERA · Karnataka Real Estate Regulatory Authority · AI Risk Engine
        </div>
                  ...
                  >
                    ...
                    <td className="px-4 py-4">
                      <div className="flex items-center gap-1.5">
                        <div className={`w-1.5 h-1.5 rounded-full ${ac.dotBg}`} />
                        <span className={`text-[9px] font-mono ${ac.textColor}`}>{ac.label.toUpperCase()}</span>
                      </div>
                    </td>
                    <td className="px-4 py-4">
            ...
            return (
              ...
              >
                <Link
                  ...
                  className={`block border rounded-sm p-4 sm:p-5 transition-all group ${
                    row.action === 'ENFORCE'
                  ...
                  <div className="flex items-center gap-4 mb-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <span className="font-mono text-[9px] uppercase tracking-[0.22em] text-gray">Default Probability</span>
